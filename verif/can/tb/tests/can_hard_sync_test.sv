// PROT-03: Hard Synchronization Test
class can_hard_sync_test extends uvm_test;
  `uvm_component_utils(can_hard_sync_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_hard_sync_seq seq;

  function new(string name = "can_hard_sync_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_hard_sync_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting PROT-03: Hard Sync Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "PROT-03: TEST COMPLETE", UVM_LOW)
