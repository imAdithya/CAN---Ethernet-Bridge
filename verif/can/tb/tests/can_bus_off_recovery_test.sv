// ERR-04: Bus-off Recovery Test
class can_bus_off_recovery_test extends uvm_test;
  `uvm_component_utils(can_bus_off_recovery_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_bus_off_recovery_seq seq;

  function new(string name = "can_bus_off_recovery_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_bus_off_recovery_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting ERR-04: Bus-off Recovery Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "ERR-04: TEST COMPLETE", UVM_LOW)
