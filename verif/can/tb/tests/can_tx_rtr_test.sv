// TX-03: Remote Transmission Request (RTR) Test
class can_tx_rtr_test extends uvm_test;
  `uvm_component_utils(can_tx_rtr_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_tx_rtr_seq rtr_seq;

  function new(string name = "can_tx_rtr_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    rtr_seq = can_tx_rtr_seq::type_id::create("rtr_seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting TX-03: RTR Test with E2E Verification", UVM_LOW)
    rtr_seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "TX-03: TEST COMPLETE", UVM_LOW)
