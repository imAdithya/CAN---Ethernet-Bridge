...
class can_form_error_test extends uvm_test;
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting ERR-09: Form Error Test", UVM_LOW)
    ...
    fork
      ...
      begin
        ...
        #70us; // Wait until EOF (approx bit 80+ for DLC=8 with overhead)
    ...
    #50000ns;
    `uvm_info("TEST", "ERR-09: TEST COMPLETE", UVM_LOW)
