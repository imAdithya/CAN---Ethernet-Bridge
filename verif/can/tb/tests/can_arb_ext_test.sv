// PROT-06: Arbitration Logic (Extended ID) Test
class can_arb_ext_test extends uvm_test;
  `uvm_component_utils(can_arb_ext_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_arb_ext_seq seq;

  function new(string name = "can_arb_ext_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_arb_ext_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting PROT-06: Arbitration EXT Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "PROT-06: TEST COMPLETE", UVM_LOW)
