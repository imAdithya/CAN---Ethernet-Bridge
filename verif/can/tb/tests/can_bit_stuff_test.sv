// PROT-02: Bit Stuffing / Destuffing Test
class can_bit_stuff_test extends uvm_test;
  `uvm_component_utils(can_bit_stuff_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_bit_stuff_seq seq;

  function new(string name = "can_bit_stuff_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_bit_stuff_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting PROT-02: Bit Stuffing Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "PROT-02: TEST COMPLETE", UVM_LOW)
