// TX-04: Data Length Code (DLC) Variation Test
class can_tx_dlc_rand_test extends uvm_test;
  `uvm_component_utils(can_tx_dlc_rand_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_tx_dlc_rand_seq dlc_seq;

  function new(string name = "can_tx_dlc_rand_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    dlc_seq = can_tx_dlc_rand_seq::type_id::create("dlc_seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting TX-04: DLC Variation Test", UVM_LOW)
    dlc_seq.start(env.agt.sequencer);
    #100000ns;
    `uvm_info("TEST", "TX-04: TEST COMPLETE", UVM_LOW)
