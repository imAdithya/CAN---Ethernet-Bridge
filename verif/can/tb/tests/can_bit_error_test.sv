// ERR-07: Bit Error Test
class can_bit_error_test extends uvm_test;
  `uvm_component_utils(can_bit_error_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_bit_error_seq seq;

  function new(string name = "can_bit_error_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_bit_error_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting ERR-07: Bit Error Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "ERR-07: TEST COMPLETE", UVM_LOW)
