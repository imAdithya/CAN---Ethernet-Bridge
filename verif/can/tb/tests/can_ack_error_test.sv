...
class can_ack_error_test extends uvm_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_ack_error_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting ERR-05: ACK Error Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "ERR-05: TEST COMPLETE", UVM_LOW)
