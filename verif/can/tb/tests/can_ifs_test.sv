// PROT-08: Interframe Space (IFS) Test
class can_ifs_test extends uvm_test;
  `uvm_component_utils(can_ifs_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_ifs_seq seq;

  function new(string name = "can_ifs_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_ifs_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting PROT-08: IFS Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "PROT-08: TEST COMPLETE", UVM_LOW)
