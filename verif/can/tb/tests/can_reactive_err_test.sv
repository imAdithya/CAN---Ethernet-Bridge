// ERR-10: Reactive Error Flag Test
class can_reactive_err_test extends uvm_test;
  `uvm_component_utils(can_reactive_err_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_reactive_err_seq seq;

  function new(string name = "can_reactive_err_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_reactive_err_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting ERR-10: Reactive Error Flag Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "ERR-10: TEST COMPLETE", UVM_LOW)
