// PROT-04: Resynchronization (SJW) Test
class can_resync_sjw_test extends uvm_test;
  `uvm_component_utils(can_resync_sjw_test)
  wb_can_env env;
  can_bus_pkg::can_bus_agent can_agt;
  can_resync_sjw_seq seq;

  function new(string name = "can_resync_sjw_test", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    seq = can_resync_sjw_seq::type_id::create("seq");
  endfunction
  ...
  task run_phase(uvm_phase phase);
    ...
    #300ns;
    `uvm_info("TEST", "Starting PROT-04: Resync SJW Test", UVM_LOW)
    seq.start(env.agt.sequencer);
    #50000ns;
    `uvm_info("TEST", "PROT-04: TEST COMPLETE", UVM_LOW)
