// ERR-09: Form Error Sequence
class can_form_error_seq extends uvm_sequence#(wb_can_trans);
  ...
  virtual task body();
    ...
    `uvm_info(get_name(), "=== ERR-09: FORM ERROR TEST START ===", UVM_LOW)
    ...
    `uvm_info(get_name(), "=== ERR-09: FORM ERROR TEST COMPLETE ===", UVM_LOW)
  endtask
endclass
