// PROT-06: Arbitration Logic (Extended ID) Sequence
class can_arb_ext_seq extends uvm_sequence#(wb_can_trans);
  `uvm_object_utils(can_arb_ext_seq)

  function new(string name = "can_arb_ext_seq");
    super.new(name);
  endfunction
  ...
  virtual task body();
    logic [7:0] alc;
    `uvm_info(get_name(), "=== PROT-06: ARBITRATION EXT TEST START ===", UVM_LOW)
    ...
    // Transmit EFF Frame
    wb_write(8'h10, 8'h82); // EFF, DLC=2
    wb_write(8'h11, 8'h55); wb_write(8'h12, 8'h55); 
    wb_write(8'h13, 8'h55); wb_write(8'h14, 8'h55); // ID=0x15555555
    wb_write(8'h15, 8'h11); wb_write(8'h16, 8'h22); // Data
    ...
    `uvm_info(get_name(), "=== PROT-06: ARBITRATION EXT TEST COMPLETE ===", UVM_LOW)
  endtask
endclass
